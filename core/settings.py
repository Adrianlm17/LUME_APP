...
SECRET_KEY = 'django-insecure-bj5b@#n@d&t3s553ju3zyap%9n8dew@hp)b*l)#+6^ttp0khk7'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'lume.app.official@gmail.com'
EMAIL_HOST_PASSWORD = 'hwfp rmcq abgr vppa'
